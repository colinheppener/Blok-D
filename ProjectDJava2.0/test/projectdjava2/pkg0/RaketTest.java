...
public class RaketTest {
    ...
    @Test
    public void testSchietMuurTweeVeldenWeg() {
        Muur muur = new Muur();
        ...
        raket.setVeld(veld);
        raket.schiet();
        String result = String.valueOf(raket.getVeld().getLocatie());
        assertEquals(expResult, result);
    }

    @Test
    public void testSchietMuurEenVeldWeg() {
        Muur muur = new Muur();
        HashMap bur = new HashMap<>();
        HashMap bur2 = new HashMap<>();
        HashMap bur3 = new HashMap<>();
        Veld veldOost = new Veld(locBuurOost, muur);
        Veld veldOost2 = new Veld(locBuurOost2, null);
        bur.put("oost", veldOost);
        bur2.put("oost", veldOost2);
        ...
        @Test
    public void testSchietItem() {
            Frame fr = new Frame();
        Valsspeler vs = new Valsspeler(fr, 10);
        HashMap bur = new HashMap<>();
        HashMap bur2 = new HashMap<>();
        HashMap bur3 = new HashMap<>();
        ...
        bur.put("oost", veldOost);
        bur2.put("oost", veldOost2);
        String expResult = "java.awt.Point[x=3,y=1]";
        Veld veld = new Veld(locRaketStart, null);
        raket = new Raket(veld, "oost");
        veld.setBuren(bur);
        veldOost.setBuren(bur2);
    ...
    public void testSchietGeenVeld() {
            Frame fr = new Frame();
        Valsspeler vs = new Valsspeler(fr, 10);
        HashMap bur = new HashMap<>();
        HashMap bur2 = new HashMap<>();
